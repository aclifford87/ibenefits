...
<footer class="container pt-5" >
    ...
    <p class="float-right"> <i class="fab fa-facebook-f"></i> <i class="fab fa-twitter"></i> <i class="fab fa-instagram"></i></p>
    <p>&copy; Copyright 2018 Growth Partners PLC &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a> &middot; <a href="#">Back to top</a></p>
    </div>
</footer>