    ...
    <main role="main">
        ...
        <div class="container marketing font-weight-light">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <img class="rounded-circle float-right" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="180" height="180">
                    {{--<h2>Lifestyle Concierge</h2>--}}
